...
[input]  
1. 첫 줄에 수의 갯수 N2. i번째 수를 나타내는 A가 N개 주어짐  
...
- 즉, 둘의 합산이 대상과 일치하는지 확인하면 됨  
    1. 작으면 왼쪽 포인터 +1    2. 크면 오른쪽 포인터 -1- 이렇게 하면 매번 모든 케이스를 살필 필요가 없음  
...
if __name__ == '__main__':  
    ...
    for i in range(N):  
        ...
        while left_pointer < right_pointer:  
            ...
            if sum < numbers[i]: left_pointer += 1  # 현재 값보다 합산이 작으면 left 인덱스 +1            else: right_pointer -= 1  # 현재 값보다 합산이 크면 right 인덱스 -1  
    print(result)